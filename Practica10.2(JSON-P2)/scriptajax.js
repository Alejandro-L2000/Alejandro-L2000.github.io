...
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    ...
    tileSize: 512,
    zoomOffset: -1,
    accessToken: 'pk.eyJ1IjoiYWxlamFuZHJvbDIwMDAiLCJhIjoiY2tuYXMwMXJjMWtoODJ3bWx6NnpkZXVvdiJ9.kHpGfgqATgIU8G5fObedyw'
}).addTo(mymap);
...
function onMapClick(e) {
    ...
    maker = L.marker([e.latlng.lat, e.latlng.lng]).addTo(mymap);
